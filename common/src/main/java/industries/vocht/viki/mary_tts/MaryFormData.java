...
public class MaryFormData {
	...
	public MaryAddress hostAddress = null;
	...
	public MaryFormData() {
		...
		MaryAddress serverAddress = new MaryAddress(serverHost, serverPort);
		init(serverAddress, null, null, null, null, null, null, null, null);
	}

	public MaryFormData(MaryAddress serverAddress) {
		init(serverAddress, null, null, null, null, null, null, null, null);
	}

	public MaryFormData(MaryAddress serverAddress, String versionIn, String voicesIn, String dataTypesIn,
	...
	public MaryFormData(MaryAddress serverAddress, Map<String, String> keyValuePairsIn, String versionIn, String voicesIn,
	...
	public void init(MaryAddress serverAddress, Map<String, String> keyValuePairsIn, String versionIn, String voicesIn,
                     String dataTypesIn, String audioFileFormatTypesIn, String audioEffectHelpTextLineBreakIn, String defaultAudioEffects,
                     Vector<String> defaultVoiceExampleTexts) {
	...
	public void toLocales(String info) {
		...
		for (String localeName : MaryUtils.toStringArray(info)) {
	...
	public void toAudioFileFormatAndOutTypes(String info) {
		...
		if (info != null && info.length() > 0)
			allTypes = MaryUtils.toStringArray(info);
		...
		if (allTypes != null) {
			for (int i = 0; i < allTypes.length; i++) {
				...
				try {
					audioType = MaryUtils.getAudioFileFormatType(typeName);
				} catch (Exception e) {
					isSupported = false;
				}
