...
public class MaryAddress {
    ...
    public MaryAddress(String hostIn, int portIn) {
        this(hostIn, String.valueOf(portIn));
    }

    public MaryAddress(String hostIn, String portIn) {
        init(hostIn, portIn);
    }

    public MaryAddress(String fullAddress) {
